...
orderbook <- function(x,
    ...
    ## Get rid of junk data--rows with no time information, rows that are not
    ## of type ask or bid, and rows where price/size is 0.
    ...
    ## Store the current order book as current.ob, and the user inputted names
    ## as ob.names. We use ob.names throughout the rest of the package and here
    ## is where we assign the names!
