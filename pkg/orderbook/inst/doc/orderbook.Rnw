...
The orderbook package provides functions for exploring and visualizing
...
\section*{Background}
To demonstrate the capabilities of the orderbook package, we consider
...
\section*{Future work}
There is still much room for improvement with \texttt{orderbook}. Aside
...
\section*{Conclusion}
In this short article, we have described the orderbook package. orderbook
